...
export const SuperAdmin: RouteInfo[] = [
  ...
  { path: '/demande-avance', title: 'Demande Avance',  icon:'ni-credit-card text-blue', class: '' },
  ...
  { path: '/demmandeconge', title: 'Demande Conge',  icon:'ni-user-run text-yellow', class: '' },
  { path: '/demande-avance', title: 'Demande Avance',  icon:'ni-user-run text-yellow', class: '' },
  ...
  { path: '/operation/list-operation', title: 'Operation ',  icon:'ni-money-coins text-red', class: ''  },
...
export const Admin: RouteInfo[] = [
  { path: '/dashboard', title: 'Dashboard',  icon: 'ni-tv-2 text-primary', class: '' },
  { path:  '/presence', title:'Presence',icon:'ni-bulb-61 text-red',class:''},
  { path:  '/notreentreprise', title:'Notre entreprise',icon:'ni-istanbul text-red',class:''},
  { path: '/demmandeconge', title: 'Demande Conge',  icon:'ni-user-run text-yellow', class: '' },
  { path: '/demande-avance', title: 'Demande Avance',  icon:'ni-credit-card text-blue', class: '' },
  { path: '/operation/list-operation', title: 'Operation ',  icon:'ni-money-coins text-red', class: ''  },
  { path: '/calondar', title: 'Calondar',  icon:'ni-calendar-grid-58 text-yellow', class: '' },
